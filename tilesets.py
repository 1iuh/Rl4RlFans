...
wall_light = arcade.Sprite(texture=tileset_textures[2], scale=TILE_SCALING)
wall_dark = arcade.Sprite(texture=tileset_textures[1], scale=TILE_SCALING)
floor_light = arcade.Sprite(texture=tileset_textures[12], scale=TILE_SCALING)
floor_dark = arcade.Sprite(texture=tileset_textures[11], scale=TILE_SCALING)
void = arcade.Sprite(texture=tileset_textures[100], scale=TILE_SCALING)
...
potion_0 = arcade.Sprite(texture=potions_textures[0], scale=0.4)
potion_1 = arcade.Sprite(texture=potions_textures[10], scale=0.4)
potion_2 = arcade.Sprite(texture=potions_textures[20], scale=0.4)
potion_3 = arcade.Sprite(texture=potions_textures[30], scale=0.4)
